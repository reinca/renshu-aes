...
Entity/Schema
- User Data
	- long id: unique id for database
	- String uid: unique id for server-client (main search index)
	- OffsetDateTime baseTime: renshu-aes UP-TIME
	- OffsetDateTime currentTime: requested time
